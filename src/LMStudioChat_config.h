...
#ifndef LMSTUDIO_CHAT_CONFIG_H
#define LMSTUDIO_CHAT_CONFIG_H
...
// --------------------------------------------
extern std::string g_LMStudioUrl;
extern std::string g_LMStudioModel;
extern uint32_t    g_LMStudioMaxTokens;
extern float       g_LMStudioTemperature;
extern float       g_LMStudioTopP;
extern float       g_LMStudioRepeatPenalty;
extern uint32_t    g_LMStudioContextSize;
extern uint32_t    g_LMStudioNumThreads;
extern std::string g_LMStudioStopSequence;
extern std::string g_LMStudioSystemPrompt;
extern std::string g_LMStudioSeed;
...
// Values are loaded from conf (see LMStudioChat.conf.dist)
// --------------------------------------------
...
// --------------------------------------------
class LMStudioChatConfigWorldScript : public WorldScript
{
public:
    LMStudioChatConfigWorldScript();
    void OnStartup() override;
};

#endif // LMSTUDIO_CHAT_CONFIG_H
