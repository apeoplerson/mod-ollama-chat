...
if(TARGET modules)
    ...
    if(OpenSSL_FOUND OR OPENSSL_FOUND)
        ...
        message(STATUS "[LMStudioChat] OpenSSL found - HTTPS support enabled")
    else()
        message(WARNING "[LMStudioChat] OpenSSL not found - only HTTP support available")
        message(STATUS "[LMStudioChat] To enable HTTPS: install OpenSSL development libraries")
        if(WIN32)
            message(STATUS "[LMStudioChat] Windows: Install vcpkg and run 'vcpkg install openssl'")
        else()
            message(STATUS "[LMStudioChat] Linux: apt install libssl-dev (Ubuntu/Debian) or yum install openssl-devel (RHEL/CentOS)")
        endif()
    endif()
